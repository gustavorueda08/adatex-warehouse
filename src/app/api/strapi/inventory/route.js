...
export async function GET(request) {
  try {
    ...
    const strapiUrl = new URL("/api/inventory", STRAPI_URL.toString());
    ...
    // Normalizar la respuesta: si es un array, envolverlo en el formato estándar
    // Esto es necesario porque el endpoint de inventory devuelve un array directamente
