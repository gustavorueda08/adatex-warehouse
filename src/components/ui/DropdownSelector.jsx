...
export default function DropdownSelector({
  ...
  return (
    <div ref={ref} className={classNames(["relative", className])}>
      {/* Botón principal */}
      <button
        className="text-white bg-zinc-700 hover:bg-zinc-600 focus:outline-none focus:ring-2 focus:ring-zinc-500 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center justify-between w-full transition-colors"
        type="button"
